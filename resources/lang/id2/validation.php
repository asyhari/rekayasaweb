...
return [
   ...
   /* 'custom' => [
        ...
        'password' => [
            ...
            'in'        => 'Kolom level harus di isi operator atau admin'
        ],

         'fotoa' => [
            'image'  => 'Kolom foto hanya boleh berisi file gambar',
             'max'       => 'Kolom foto tidak boleh lebih dari :max karakter',
              'mimes'       => 'Kolom foto hanya boleh diisi file *.jpeg, *.jpg, *.bmp, *.png.',
        ],
*/
    /*
    |--------------------------------------------------------------------------
